...
// переменная для хранения времени последнего подключения к серверу
unsigned long lastConnectionTime = 0;
// интевал отправки HTTP-запроса
...
void loop()
{
  ...
  // если прошёл заданный интевал времени
...
// формируем HTTP-запрос на сервер
void httpRequest() {
